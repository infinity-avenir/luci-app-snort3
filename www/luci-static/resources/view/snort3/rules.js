...
var RULE_SOURCES = [
	{ val: 'auto',      label: 'Auto-detect from Snort version' },
	{ val: 'community', label: 'Community rules (free, no oinkcode)' },
	{ val: 'https://snort.org/downloads/registered/snortrules-snapshot-31470.tar.gz', label: 'snortrules-snapshot-31470' },
	{ val: 'https://snort.org/downloads/registered/snortrules-snapshot-31440.tar.gz', label: 'snortrules-snapshot-31440' },
	{ val: 'https://snort.org/downloads/registered/snortrules-snapshot-31350.tar.gz', label: 'snortrules-snapshot-31350' },
	{ val: 'https://snort.org/downloads/registered/snortrules-snapshot-31210.tar.gz', label: 'snortrules-snapshot-31210' },
	{ val: 'https://snort.org/downloads/registered/snortrules-snapshot-31200.tar.gz', label: 'snortrules-snapshot-31200' },
	{ val: 'https://snort.org/downloads/registered/snortrules-snapshot-31180.tar.gz', label: 'snortrules-snapshot-31180' },
	{ val: 'https://snort.org/downloads/registered/snortrules-snapshot-31150.tar.gz', label: 'snortrules-snapshot-31150' },
	{ val: 'https://snort.org/downloads/registered/snortrules-snapshot-31110.tar.gz', label: 'snortrules-snapshot-31110' },
	{ val: 'https://snort.org/downloads/registered/snortrules-snapshot-31100.tar.gz', label: 'snortrules-snapshot-31100' },
	{ val: 'https://snort.org/downloads/registered/snortrules-snapshot-3900.tar.gz',  label: 'snortrules-snapshot-3900' },
	{ val: 'https://snort.org/downloads/registered/snortrules-snapshot-3700.tar.gz',  label: 'snortrules-snapshot-3700' },
	{ val: 'https://snort.org/downloads/registered/snortrules-snapshot-3370.tar.gz',  label: 'snortrules-snapshot-3370' },
	{ val: 'https://snort.org/downloads/registered/snortrules-snapshot-3360.tar.gz',  label: 'snortrules-snapshot-3360' },
	{ val: 'https://snort.org/downloads/registered/snortrules-snapshot-3351.tar.gz',  label: 'snortrules-snapshot-3351' },
	{ val: 'https://snort.org/downloads/registered/snortrules-snapshot-3200.tar.gz',  label: 'snortrules-snapshot-3200' },
	{ val: 'https://snort.org/downloads/registered/snortrules-snapshot-29200.tar.gz', label: 'snortrules-snapshot-29200' },
	{ val: 'https://snort.org/downloads/registered/snortrules-snapshot-29181.tar.gz', label: 'snortrules-snapshot-29181' },
	{ val: 'https://snort.org/downloads/registered/snortrules-snapshot-29171.tar.gz', label: 'snortrules-snapshot-29171' },
...
return view.extend({
	...
	handleUpdate: function() {
		...
		} else if (sel !== 'auto' && sel !== 'community') {
			url = sel;
		} else if (sel === 'community') {
			url = 'community';
		}
		/* 'auto' sends empty string — the worker auto-detects */
	...
	render: function(data) {
		...
		this.customUrlRow = E('div', { 'style': 'margin-top:6px;display:none' }, [
			this.customUrlInput
		]);
		...
		var body = E('div', { 'class': 'snort3' }, [
			...
			E('p', { 'class': 's3-note' },
				_('Select a rule source from the list, or enter a custom URL. Subscription URLs require an oinkcode (set above). The oinkcode is appended automatically for subscription downloads.')),
			E('div', { 'style': 'margin-bottom:8px' }, [
				this.ruleSourceSelect,
				this.customUrlRow
			]),
			E('div', { 'class': 's3-toolbar' }, [
				this.updateBtn
